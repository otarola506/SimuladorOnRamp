...
function formd0(x){return parseFloat(x).toFixed(0);}
    // entrada Circunvalación y pista
var qIn = 0;
var qOn = 0;
function pararPrograma(){
    clearInterval(myRun);
    setParametros(300,1000,10000)
...
// inflow slider 
//Flujo que hay de la autopista
    //total inflow, overridden in roadworks.js, routing.js
...
//total onramp flow of onramp scenario
...
if(document.getElementById("slider_IDM_v0")===null) 
   ...
   slider_IDM_v0Val.innerHTML=parseInt(3.6*IDM_v0)+" km/h";
